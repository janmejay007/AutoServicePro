...
const AdminTables = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8181/admin/service')
            .then(response => {
    ...
    //     alert(serviceId)
    //     axios.delete(`http://localhost:8181/admin/service/${serviceId}`)
    //         .then(response => {
    ...
    useEffect(() => {
        axios.get('http://localhost:8181/admin/user')
            .then(response => {
    ...
    const handleChangeRole = () => {
        ...
        if (selectedUser.role !== 'ADMIN') {
            axios.put(`http://localhost:8181/admin/user/`, selectedUser)
        .then(response => {
    ...
    //     axios.put(`http://localhost:8181/admin/user/${selectedUser.userId}`, { role: selectedUser.role }).then(response => {
    ...
    const handleAddService = () => {
        ...
        axios.post('http://localhost:8181/admin/service', newService)
            .then(response => {
    ...
    //     axios.put(`http://localhost:8181/admin/service/${editedService.serviceId}`, editedService)
    //         .then(response => {
...
const handleSaveEditedService = () => {
    ...
    axios.put(`http://localhost:8181/admin/service`, editedService)
        .then(response => {
            const updatedServices = services.map(service =>
                service.serviceId === editingService.serviceId ? { ...service, ...editedService } : service
            );
